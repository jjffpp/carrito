...
public class Carrito  implements java.io.Serializable {
    ...
    public void setProductos(Set<Producto> productos) {
     ...
     public String carritoAsString() {
        return "carrito numero "+ this.getIdcarrito()+" usuario: "+this.usuario.getNombre()+" productos: "+this.dameProductos();
    }
    public String dameProductos(){
        String concat = "";
        int valor=0;
        for (Producto p : this.getProductos()){
          concat += p.productoAsString()+" - ";
          valor += p.getValor();
        }
        return concat + "total compra: "+ valor;
    }
